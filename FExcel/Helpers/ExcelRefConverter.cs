...
namespace FastExcelDNA
{
    public static class ExcelRefConverter
    {
        ...
        private const string categoryFunction = "Reference Converter";
        ...
        // Преобразует в адрес типа A1:B2
        [ExcelFunction(Category = categoryFunction, Description = "Преобразует в адрес типа A1:B2")]
        ...
        // Преобразует из адреса в номера строк/столбцов
        [ExcelFunction(Category = categoryFunction, Description = "Преобразует из адреса в номера строк/столбцов [RowFirst, ColumnFirst, RowLast, ColumnLast]")]
        ...
        [ExcelFunction(Category = categoryFunction, Description = "Преобразует адрес диапазона для ADO в нужный формат A1:A1")]
        ...
        [ExcelFunction(IsHidden = true, Category = categoryFunction, Description = "Преобразует из адреса в номера строк/столбцов [RowFirst, ColumnFirst, RowLast, ColumnLast]")]
